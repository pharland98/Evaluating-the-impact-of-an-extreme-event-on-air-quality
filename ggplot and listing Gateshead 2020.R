...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Jan20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Jan20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Feb20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Feb20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
Air_Quality <- read.csv("Gateshead_Mar20_Clean.csv", header= TRUE)
library(tidyr)
#########
############
summary(Air_Quality)
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Mar20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Mar20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Apr20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Apr20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean May20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot May20 .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
