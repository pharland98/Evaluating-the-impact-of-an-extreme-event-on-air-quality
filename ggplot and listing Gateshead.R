...
#
#
Sound_df <- Mean_lists_day[4]%>%
  map_df(as_tibble)##to convert any list to data tibble
###########
###remove outliers for CO
boxplot(Sound_df$Value)
boxplot(Sound_df$Value,plot=FALSE)$out
outliers <- boxplot(Sound_df$Value,plot=FALSE)$out
print(outliers)

Sound_df<Sound_df[-which(Sound_df$Value %in% outliers),]
boxplot(Sound_df$Value)
str(Sound_df)
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Aug .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Aug .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Sep .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Sep .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Oct .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Oct .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Nov .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Nov .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()
p
ggsave("Sound month Mean Dec .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
...
p<- Sound_df %>%
  ...
  theme_bw()###needs some time
p
ggsave("Sound month Boxplot Dec .jpg", p, width = 24, height = 14,dpi = 300 )#save to file
